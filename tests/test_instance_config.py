...
from instance_config import get_instance_label, instance_page_title_suffix, normalize_instance_key
...
def test_normalize_instance_key() -> None:
    assert normalize_instance_key(None) == "1"
    assert normalize_instance_key("northstar") == "1"
    assert normalize_instance_key("northstar2") == "2"
    assert normalize_instance_key("northstar-3") == "3"
    assert normalize_instance_key("6") == "6"
